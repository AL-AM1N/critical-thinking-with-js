...
const result = sales.reduce((acc, sale) => {
  ...
  acc[sale.category].totalRevenue = acc[sale.category].totalRevenue + (sale.price * sale.quantity);

  acc[sale.category].itemCount = acc[sale.category].itemCount + sale.quantity;
