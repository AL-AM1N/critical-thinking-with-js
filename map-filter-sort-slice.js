...
const filterData = rawApiData.filter((item) => {
    if(item.category === "Electronics" ){
        return item;
    }
})

const sortByRating = filterData.sort((a, b) => b.rating - a.rating)

const topThree = sortByRating.slice(0, 3)

const topProduct = topThree.map((product) => {
